...
{
    class SupplierUCViewModel : BaseViewModel
    {
        #region Properties
        ...
        async void LoadList()
        {
            ...
            Task task = Task.Run(() => { ListSuppliers = new ObservableCollection<Supplier>(DataProvider.Instance.DB.Suppliers); });
            await task;
