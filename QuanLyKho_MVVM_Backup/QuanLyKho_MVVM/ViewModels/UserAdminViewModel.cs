    ...
    class UserAdminViewModel : BaseViewModel
    {
        ...
        public UserAdminViewModel()
        {
            ...
            EditCommand = new RelayCommand<object>((p) =>
            {
                ...
                var item = DataProvider.Instance.DB.Users.Where(x => x.Id == SelectedItem.Id);
            ...
            }, (p) =>
            {
                ...
                else
                {
                    ...
                    MessageBox.Show("Vui lòng nhập đủ thông tin", "Thông báo", MessageBoxButton.OK, MessageBoxImage.Error);
                }
            });
